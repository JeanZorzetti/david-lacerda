...
export const metadata: Metadata = buildMetadata({
  title: "Telemedicina",
  description:
    "Entenda como funciona a telemedicina da David Lacerda Telemedicina — segura, regulamentada pelo CFM, e com a qualidade de uma consulta presencial.",
  path: "/telemedicina",
});
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 py-16 md:py-24">
        ...
        <div className="max-w-3xl">
          ...
          <p className="text-lg md:text-xl text-[#4a454e] mb-8 max-w-2xl">
            A telemedicina da David Lacerda Telemedicina é regulamentada pelo CFM, segura e tão eficaz
