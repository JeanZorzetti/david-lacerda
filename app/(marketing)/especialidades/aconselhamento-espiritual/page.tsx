  ...
  return (
    <SpecialtyPage
      ...
      about={[
        ...
        "As sessões de aconselhamento da David Lacerda Telemedicina seguem princípios consolidados de escuta ativa, orientação e suporte, integrando os valores e a história de vida do paciente ao processo de cuidado.",
      ...
      faq={[
        ...
        },
        {
          ...
          a: "Há extensa literatura científica sobre o impacto positivo do suporte emocional, do senso de propósito e dos vínculos sociais na saúde mental e física. A David Lacerda Telemedicina integra essas perspectivas com responsabilidade.",
        },
        {
