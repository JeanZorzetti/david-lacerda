...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Planos alimentares personalizados via telemedicina com base em evidências. Médicos parceiros da David Lacerda Telemedicina integram nutrição clínica e cuidado integral.",
  ...
  return (
    <SpecialtyPage
      ...
      about={[
        ...
        "Os médicos da David Lacerda Telemedicina abordam a nutrição como parte do cuidado integral: o que comemos afeta não apenas o peso corporal, mas o humor, a disposição, a imunidade e a saúde mental como um todo.",
