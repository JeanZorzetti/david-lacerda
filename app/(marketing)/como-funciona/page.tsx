...
export const metadata: Metadata = buildMetadata({
  title: "Como Funciona",
  description:
    "Passo a passo da consulta online na David Lacerda Telemedicina. Do cadastro à receita digital — entenda tudo antes de agendar.",
  path: "/como-funciona",
});
...
export default function ComoFuncionaPage() {
  ...
  const jsonLdHowTo = {
    ...
    "@type": "HowTo",
    name: "Como fazer uma consulta de telemedicina na David Lacerda Telemedicina",
